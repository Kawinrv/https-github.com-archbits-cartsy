    ...
    return (<div className="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/myshop">My Shop</a></li>
                <li class="breadcrumb-item active" aria-current="page">{product != undefined ? resolveCategory(product.categoryId) : ""}</li>
            </ol>
        </nav>
