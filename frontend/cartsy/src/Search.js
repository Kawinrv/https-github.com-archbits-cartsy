...
const Search = () => {
    ...
    if(q!==localStorage.getItem("q")){
        localStorage.setItem("q",q);
        window.location.reload();
    }

    function loadProducts() {
        const url = "http://localhost:8080/api/v1/public/products/search?searchText=" + q;
    ...
    return (
        <div>
            <div className="container">
                <br />
                <h2 className="muted">Search Results</h2>
                <br />
                    <div className="row">
                        {

                            searchLoaded?filteredProducts.map(item => {
                                return (
