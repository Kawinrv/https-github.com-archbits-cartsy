...
const Deal = () => {
    ...
    function loadDeal(id) {
        ...
        const url = "http://localhost:8080/api/v1/public/deals/" + q;
    ...
    function loadProducts(q) {
        const url = "http://localhost:8080/api/v1/public/products/deal/"+q;
        var myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json");
        myHeaders.append("Accept", "application/json");
    ...
    return (
        <div>
            <div className="container">
                <br />
                <h2 className="muted">{productDeal.dealName}</h2>
                <br />
                    <div className="row">
                        {
